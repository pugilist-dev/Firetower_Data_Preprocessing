...
# -*- coding: utf-8 -*-
"""
Created on Fri May 28 14:10:25 2021
...
parser.add_argument("--src", type=str, default="/data/data/missions/20190327_firetower/Missions/1930/makoG419/processed/", help="3 band mako sensor data")
parser.add_argument("--dest", type=str, default="/home/raj/ft_im_to_pc/data/interim/images/", help="path to store .png image")
parser.add_argument("--pc_path", type=str, default="/home/raj/ft_im_to_pc/data/raw/point_cloud/mako_1930_FullRes_reprocessed_2021_group1_densified_point_cloud.laz", help="Point cloud path")
parser.add_argument("--xyz_path", type=str, default="/home/raj/ft_im_to_pc/data/raw/point_cloud/mako_1930_FullRes_reprocessed_2021_group1_densified_point_cloud.xyz", help="Point Cloud lat, long data file")
parser.add_argument("--pc_dest", type=str, default="/home/raj/ft_im_to_pc/data/interim/point_cloud/", help = "sampled point cloud destination")
...
def process_img_pc(hdrlist, imglist, opt, mode):
    ...
    df['red'] = np.asarray(pcd.colors)[:-1,0]
    df['green'] = np.asarray(pcd.colors)[:-1,1]
    df['blue'] = np.asarray(pcd.colors)[:-1,2]
    ...
    for i in imglist:
        ...
        colors = np.vstack((interim_pc.red, interim_pc.green, interim_pc.blue)).transpose()
        pc = o3d.geometry.PointCloud()
        pc.points = o3d.utility.Vector3dVector(points)
        pc.colors = o3d.utility.Vector3dVector(colors)
        #pc.estimate_normals()
        #poisson_mesh = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(pc,
        #                                        depth=8, width=0, scale=1.1,
        #                                        linear_fit=False)[0]
        #downpcd = pc.voxel_down_sample(voxel_size=0.6)
...
if __name__=="__main__":
    ...
    process_img_pc(val_hdr, val_img, opt, mode="val")